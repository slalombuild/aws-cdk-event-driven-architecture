...
BaseDataSource[_a] = { fqn: "aws-cdk-lib.aws_appsync.BaseDataSource", version: "2.76.0" };
...
BackedDataSource[_b] = { fqn: "aws-cdk-lib.aws_appsync.BackedDataSource", version: "2.76.0" };
...
NoneDataSource[_c] = { fqn: "aws-cdk-lib.aws_appsync.NoneDataSource", version: "2.76.0" };
...
DynamoDbDataSource[_d] = { fqn: "aws-cdk-lib.aws_appsync.DynamoDbDataSource", version: "2.76.0" };
...
HttpDataSource[_e] = { fqn: "aws-cdk-lib.aws_appsync.HttpDataSource", version: "2.76.0" };
...
LambdaDataSource[_f] = { fqn: "aws-cdk-lib.aws_appsync.LambdaDataSource", version: "2.76.0" };
...
RdsDataSource[_g] = { fqn: "aws-cdk-lib.aws_appsync.RdsDataSource", version: "2.76.0" };
...
ElasticsearchDataSource[_h] = { fqn: "aws-cdk-lib.aws_appsync.ElasticsearchDataSource", version: "2.76.0" };
...
OpenSearchDataSource[_j] = { fqn: "aws-cdk-lib.aws_appsync.OpenSearchDataSource", version: "2.76.0" };
