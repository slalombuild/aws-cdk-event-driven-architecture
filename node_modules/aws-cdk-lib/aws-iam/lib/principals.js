...
ComparablePrincipal[_a] = { fqn: "aws-cdk-lib.aws_iam.ComparablePrincipal", version: "2.76.0" };
...
PrincipalBase[_b] = { fqn: "aws-cdk-lib.aws_iam.PrincipalBase", version: "2.76.0" };
...
PrincipalWithConditions[_c] = { fqn: "aws-cdk-lib.aws_iam.PrincipalWithConditions", version: "2.76.0" };
...
SessionTagsPrincipal[_d] = { fqn: "aws-cdk-lib.aws_iam.SessionTagsPrincipal", version: "2.76.0" };
...
PrincipalPolicyFragment[_e] = { fqn: "aws-cdk-lib.aws_iam.PrincipalPolicyFragment", version: "2.76.0" };
...
ArnPrincipal[_f] = { fqn: "aws-cdk-lib.aws_iam.ArnPrincipal", version: "2.76.0" };
...
AccountPrincipal[_g] = { fqn: "aws-cdk-lib.aws_iam.AccountPrincipal", version: "2.76.0" };
...
ServicePrincipal[_h] = { fqn: "aws-cdk-lib.aws_iam.ServicePrincipal", version: "2.76.0" };
...
OrganizationPrincipal[_j] = { fqn: "aws-cdk-lib.aws_iam.OrganizationPrincipal", version: "2.76.0" };
...
CanonicalUserPrincipal[_k] = { fqn: "aws-cdk-lib.aws_iam.CanonicalUserPrincipal", version: "2.76.0" };
...
FederatedPrincipal[_l] = { fqn: "aws-cdk-lib.aws_iam.FederatedPrincipal", version: "2.76.0" };
...
WebIdentityPrincipal[_m] = { fqn: "aws-cdk-lib.aws_iam.WebIdentityPrincipal", version: "2.76.0" };
...
OpenIdConnectPrincipal[_o] = { fqn: "aws-cdk-lib.aws_iam.OpenIdConnectPrincipal", version: "2.76.0" };
...
SamlPrincipal[_p] = { fqn: "aws-cdk-lib.aws_iam.SamlPrincipal", version: "2.76.0" };
...
SamlConsolePrincipal[_q] = { fqn: "aws-cdk-lib.aws_iam.SamlConsolePrincipal", version: "2.76.0" };
...
AccountRootPrincipal[_r] = { fqn: "aws-cdk-lib.aws_iam.AccountRootPrincipal", version: "2.76.0" };
...
AnyPrincipal[_s] = { fqn: "aws-cdk-lib.aws_iam.AnyPrincipal", version: "2.76.0" };
...
Anyone[_t] = { fqn: "aws-cdk-lib.aws_iam.Anyone", version: "2.76.0" };
...
StarPrincipal[_u] = { fqn: "aws-cdk-lib.aws_iam.StarPrincipal", version: "2.76.0" };
...
CompositePrincipal[_v] = { fqn: "aws-cdk-lib.aws_iam.CompositePrincipal", version: "2.76.0" };
